<?php
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://api.themoviedb.org/3/movie/top_rated?api_key=b99763c67f88c812779d81b9bc402dd2");
                ...
                ?>
                    <div class="col-12 col-md-3">
                        <div class="card" style="margin-bottom:25px">
                            <img class="card-img-top" src="https://image.tmdb.org/t/p/w185/<?php echo $data->results[$x]->poster_path ?>" alt="Card image cap">
                            <div class="card-body">
